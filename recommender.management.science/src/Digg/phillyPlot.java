...
public class phillyPlot extends ApplicationFrame
{
    private static String FILE_PATH = 
	    "C" + ":" + File.separator + "academic" + File.separator+"recommender system 2"+File.separator
	    +"Management Science"+File.separator + "philly-clicks" + File.separator;
    ...
    public phillyPlot(String title) 
    {
	super(title);
	prepareData();
	//timeNormal();
	...
	try
	{
	    //BufferedReader in = new BufferedReader(new FileReader(FILE_PATH + "philly_sorted.csv"));
	    BufferedReader in = new BufferedReader(new FileReader(FILE_PATH + "philly_clicksplot.csv"));
	...
	try
	{
	    BufferedWriter out = new BufferedWriter(new FileWriter(FILE_PATH + "philly_clicksnormal.csv"));
